...
function Flag({ locale }: { locale: Locale }) {
  return (
    <svg viewBox="0 0 30 20" width="22" height="15" aria-hidden="true" data-language-flag={locale}>
      {locale === "fr" ? (
        <>
...
/** Two always-visible flag buttons. */
export default function LanguagePicker() {
  const locale = useLocale();
  return (
    <div className="language-picker" role="group" aria-label={t("Choose language")}>
